    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("admin/patientList").hasAnyAuthority("Manager")
                        ...
                        .requestMatchers("/admin/patientList/").hasAnyAuthority("Admin","Manager")
                        ...
                        .requestMatchers("/admin/tracking").hasAnyAuthority("Manager", "Admin")
                        .requestMatchers("/admin/searchInactiveAccount").hasAnyAuthority("Manager", "Admin")
                        ...
                        .requestMatchers("/doctor/**").hasAnyAuthority("Doctor", "Nurse", "Receptionist")
                        .requestMatchers("/tracking/**").hasAnyAuthority("Doctor", "Nurse", "Receptionist", "Admin","Manager")
